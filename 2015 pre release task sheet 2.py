...
def GetMove(StartSquare, FinishSquare):
    ...
    if StartSquare == -1:
        display_ingame_menu()
        ingame_menu_selection = get_menu_selection()
        make_ingame_menu_selection(ingame_menu_selection,StartSquare, FinishSquare)
    else:
        FinishSquare = int(input("Enter coordinates of square to move piece to (file first): "))
    return StartSquare, FinishSquare

def display_ingame_menu():
        print()
        print("Option")
        print()
        print("1. Save Game")
...
def make_ingame_menu_selection(ingame_menu_selection,StartSquare, FinishSquare):
    if ingame_menu_selection == 1:
        print()
        #save game
    elif ingame_menu_selection == 2:
        GameOver = False
    elif ingame_menu_selection == 3:
